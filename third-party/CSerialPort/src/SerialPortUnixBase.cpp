                                  ...
                                  itas109::FlowControl flowControl)
{
    ...
    switch (parity)
    {
        ...
        //case 'N'://Del Begin by wuchunming,20210716, case value ‘78’ not in enumerated type ‘itas109::Parity’
...
bool CSerialPortUnixBase::openPort()
{
    ...
    // fd = open(m_portName.c_str(), O_RDWR | O_NOCTTY | O_NDELAY | S_IRUSR | S_IXUSR | S_IRGRP | S_IXGRP | S_IROTH | S_IXOTH, 0777); //非阻塞
...
void CSerialPortUnixBase::setDtr(bool set /*= true*/) {(void)set;}

void CSerialPortUnixBase::setRts(bool set /*= true*/) {(void)set;}
