...
class FSM_State : public BZL::ActionNode{
 public:
  ...
  FSM_StateName nextStateName = FSM_StateName::INVALID;  // enumerated name of the next state
  std::string stateString;      // state name string

  // Transition parameters
  T transitionDuration = 0;  // transition duration time
  T tStartTransition = 0;    // time transition starts
