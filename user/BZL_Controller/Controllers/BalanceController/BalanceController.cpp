...
BalanceController::BalanceController()
    : _logger("BalanceController"), QProblemObj_qpOASES(NUM_VARIABLES_QP, NUM_CONSTRAINTS_QP)
  {
  ...
  if (lcm->good()) {
    QUADRUPED_INFO(_logger, "lcm init success");
  } else {
    QUADRUPED_ERROR(_logger, "lcm init failed");
...
void BalanceController::testFunction() { QUADRUPED_DEBUG(_logger, "testfun "); }
