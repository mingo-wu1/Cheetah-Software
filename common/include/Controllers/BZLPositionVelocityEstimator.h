/*! @file BZLPositionVelocityEstimator.h
...
#ifndef PROJECT_BZLPOSITIONVELOCITYESTIMATOR_H
#define PROJECT_BZLPOSITIONVELOCITYESTIMATOR_H
 ...
 */
template <typename T>
class BZLLinearKFPositionVelocityEstimator : public GenericEstimator<T> {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  BZLLinearKFPositionVelocityEstimator();
  virtual void run();
  virtual void setup();
...
#endif  // PROJECT_BZLPOSITIONVELOCITYESTIMATOR_H
